...
* extension[=].valueCanonical = "http://e-path.jp/fhir/ePath/PlanDefinition/EP01.CN05I00511-0L"
* extension[+].url = "http://e-path.jp/fhir/ePath/StructureDefinition/EPathListPathCode"
* extension[=].valueCanonical = "http://e-path.jp/fhir/ePath/PlanDefinition/EP02.4311234567.CN05I00511-0"
...
* entry[=].item.reference = "Bundle/Bundle.EP12.4311234567.CN05I00511-0L"
