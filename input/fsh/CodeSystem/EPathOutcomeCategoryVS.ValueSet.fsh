...
ValueSet: EPathOutcomeCategoryVS
Id: EPathOutcomeCategoryVS
Title: "EPath OutcomeCategory VS"
Description: "アウトカム大分類 バリューセット"
* ^version = "1.0.0"
* ^status = #active
* ^experimental = false
* ^date = "2024-10-24"
...
* include codes from system $EPathBOMOutcomeCategoryCS